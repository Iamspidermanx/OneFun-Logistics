...
const employee = {
  ...
  bio: `Asagade has over 2 years of experience in last-mile delivery and logistics. He is known for her reliability, attention to detail, and friendly customer service. Asagade ensures every package is delivered safely and on time.`,
  stats: {
    deliveries: 150,
    years: 8,
    rating: 4.9,
      ...
      {!showForm ? (
        <>
          <div className="flex flex-col lg:flex-row items-stretch gap-6 w-full max-w-5xl">
            {/* Profile Section */}
            <div
              className="bg-white rounded-lg shadow-lg p-6 sm:p-8 flex-1 flex flex-col items-center"
            >
              <img
                src={employee.photo}
                alt={employee.name}
            ...
            <div className="flex-1 flex justify-center items-center rounded-lg shadow-lg">
              <img
                src="./assets/employee.png" // Change to your preferred image
                alt="Courier at work"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 max-w-md w-full text-center">
          ...
          <button
            ...
            onClick={() => { setShowForm(false); setSubmitted(false); setForm({ name: "", email: "", phone: "", experience: "", license: "", vehicle: "", why: "" }); }}
          >
            Back to Profile
          </button>
        </div>
